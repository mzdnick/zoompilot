...
### The press-induced MRCC arm and the undo (built 2026-09-18, on-car pending, opendbc 7e41b024)
...
### The white wheel (built 2026-09-18, on-car pending, opendbc 43761317)

The camera press leaves the dash without a steering telltale while openpilot steers: the
camera's own TJA reads 0, and our 0x440 stays 0. The white wheel draws it again on the camera's
